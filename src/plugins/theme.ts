...
const tailwindConfig = {
    ...
    table: {
        ...
        // wrapperClass:
        //     "table-inner rounded-lg border border-gray-200 shadow-sm overflow-hidden",
        tableClass: "min-w-full divide-y divide-gray-200",
        borderedClass: "border border-gray-200",
        stripedClass: "[&>tbody>tr:nth-child(even)]:bg-gray-50",
        narrowedClass: "[&_td]:px-3 [&_td]:py-2 [&_th]:px-3 [&_th]:py-2",
        hoverableClass: "[&>tbody>tr:hover]:bg-gray-100",
        emptyClass: "text-center py-8 text-gray-500",
        detailedClass: "bg-gray-50",
        footerClass: "bg-gray-50 px-4 py-3 border-t",
        paginationWrapperClass: "px-4 py-3 border-t",
        scrollableClass: "overflow-x-auto",
        stickyHeaderClass: "sticky top-0 bg-white",
        ...
        thStickyClass: "sticky top-0 bg-white",
        thCheckboxClass: "w-12",
        thDetailedClass: "w-16",
        tdDetailedChevronClass: "",
        thPositionClass: "sticky left-0 bg-white",
        tdPositionClass: "sticky left-0 bg-white",
        mobileClass: "block overflow-x-auto",
        mobileSortClass: "",
    },
    tabs: {},
    taginput: {
